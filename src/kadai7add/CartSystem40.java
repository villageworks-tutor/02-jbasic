...
/**
 * 追加課題JB71 Step-4
 * 	ver.40 mainメソッドのみの完結版：最低限クリアしてほしいバージョン
 *         検索では、継承クラスのインスタンス ⇒ 基底クラスのインスタンス の順に照合する。
 *         また、一致するかどうかの判断については「String#indexOf(String)メソッドが-1以上であるかどうか」で判定する。
 */
public class CartSystem40 {
