...
/**
 * 追加課題JB41 Step-2
 * 	顧客情報（ID と名前）を 3 人分入力し、それを配列に格納し表示するプログラムを作成しなさい。
 * 	なお、ID を指定したくない場合、ID に-1 と指定します（内部的には 0 として登録される）。
 * 	UseCustomer クラス（main メソッドを定義しているクラス）の実行結果が以下になるように Customer クラスを定義しなさい。
 */
	...
	public static void main(String[] args) {
		try (Scanner scanner = new Scanner(System.in)) {
			...
			for (int index = 0; index < customerList.length; index++) {
				...
				System.out.print("ID（指定しない場合は-1と入力してください）：");
